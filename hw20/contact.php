...
<div id="page-wrapper">
<div id="page-inner">
<h1 class="text-center">Contact Form</h1><br>
...
<?php
	...
	if(!isset($_POST['submit'])){
		...
		elseif (isset($_GET['comment']))
		{
			...
			echo '<br><button class="sub-button center-block" name="submit" type="submit" value="submit">Submit</button></form>';
	}
	...
	if(isset($_POST['submit'])){
		...
		if($_POST['submit']=='submit'){
			...
			if (count($errStatus)>0)
			{
				...
				redirect("https://ec2-3-143-17-29.us-east-2.compute.amazonaws.com/hw20/index.php?page=contact&$errString");
			}
			...
			redirect("https://ec2-3-143-17-29.us-east-2.compute.amazonaws.com/hw20/index.php?page=contact&msg=success");
		}
		echo '</div>';
}
?>
